...
progenyConstructor = function(mode, _arg) {
  var exclusion, extension, extensionsList, multipass, parseDeps, prefix, progeny, progenySync, regexp, rootPath, _ref;
  _ref = _arg != null ? _arg : {}, rootPath = _ref.rootPath, extension = _ref.extension, regexp = _ref.regexp, prefix = _ref.prefix, exclusion = _ref.exclusion, extensionsList = _ref.extensionsList, multipass = _ref.multipass;
  ...
  progeny = function(data, path, callback) {
  ...
  progenySync = function(data, path) {
    var result;
    result = [];
    progeny(data, path, function(err, depsList) {
      if (err) {
        throw err;
      }
