...
progenyConstructor = function(mode, settings) {
  var altPaths, exclusion, extension, extensionsList, multipass, parseDeps, potentialDeps, prefix, progeny, progenySync, regexp, rootPath;
  if (settings == null) {
    settings = {};
  }
  rootPath = settings.rootPath, altPaths = settings.altPaths, extension = settings.extension, regexp = settings.regexp, prefix = settings.prefix, exclusion = settings.exclusion, extensionsList = settings.extensionsList, multipass = settings.multipass, potentialDeps = settings.potentialDeps;
